...
func (m *MockIUserApplication) GetUserByCredentials(user *entity.User) (*entity.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIUserApplicationMockRecorder) GetUserByCredentials(user interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUserByCredentials", reflect.TypeOf((*MockIUserApplication)(nil).GetUserByCredentials), user)
}
