...
mock:
	...
	@mockgen -source=infrastructure/service/crossService.go -destination=infrastructure/service/mock/mockCrossService.go -package=mock
	...
	@mockgen -source=application/crossApplication.go -destination=application/mock/mockCrossApplication.go -package=mock
